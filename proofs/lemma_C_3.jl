...
T_K_1_2 = 1 // 8 * (1 + C_F_N_0) * C_F_N_2

# ╔═╡ 751cb540-1243-4f9a-a54e-6669b987944e
T_K_1_3 = 1 // 24 * (1 + C_F_N_0) * C_F_N_2

# ╔═╡ 670ead62-5742-4d68-aa7d-cc7a573d4e3f
T_K_1_4 =
    1 // 96 * C_F_N_0 * (1 + C_F_N_4 / N₀^4) + 1 // 96N₀^2 * C_F_N_0 * (C_S_2 + C_S_3 / N₀)
...
T_K_2_1 =
    ...
    1 // 16N₀^4 * C_ρ_λ * C_S_2 +
    1 // 16N₀ * (1 + C_F_N_0 * (1 + C_F_N_0)) * C_F_N_2 * C_S_2
